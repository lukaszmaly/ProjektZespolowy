...
def video(request):
	...
	return render_to_response ('video.html', {'akcje':obiekt.actionlist, 'karty':obiekt.cardlist, 'mana':obiekt.manalist, 'nicki':obiekt.nicklist,            'liczniki':obiekt.liczniklist, 'liczba_akcji':obiekt.count, 'nick1' : obiekt.nick1, 'nick2':obiekt.nick2, 'len':dlugosc})
